...
import static com.example.asus.daygram.R.color.colorRed;
...
public class ListAdapter extends BaseAdapter{
    ...
    //整合数据
    private List<Daycontent> contents = new ArrayList<>();
    //传入context及Daycontent的数组（当前日记数组的数据)
     public ListAdapter(Context context, ArrayList<Daycontent> Listview) {
    ...
    //数据更新
    public void changedata(Daycontent content,int i)
    {
    ...
    //选择了新bar的数据刷新
    public void refreshdata(ArrayList<Daycontent> Listview)
    {
        this.contents = Listview;
        //Log.d(TAG,"refresh");
    }
  ...
  //          Log.d(TAG,"content="+contents.get(position).getContent());
    ...
    public View getView(int position, View convertView, ViewGroup parent) {//设置不同样式的view
        ...
        if (convertView == null) {
            ...
            switch (type) {
                case TYPE_A:
                    ...
                    convertView = View.inflate(context, R.layout.listcontent, null);
                ...
                case TYPE_B:
                    ...
                    convertView = View.inflate(context, R.layout.dot, null);
                    holder2.Dot = convertView.findViewById(R.id.greypoint);
                    convertView.setTag(R.id.tag_2,holder2);
                    break;
                case TYPE_C:
                    holder3 = new ViewHolder3();
                    convertView = View.inflate(context, R.layout.listtext, null);
                    holder3.day = (TextView) convertView.findViewById(R.id.listtext_day);
                    holder3.week = (TextView) convertView.findViewById(R.id.listtext_week);
                    holder3.content = (TextView) convertView.findViewById(R.id.listtext_content);
        ...
        Daycontent data = contents.get(position);
        String month;
        String day;
        //数据加载，设置周日为红色
        switch (type) {
